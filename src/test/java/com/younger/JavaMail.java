...
public class JavaMail {
	    ...
	    public static String myEmailAccount = "857659628@qq.com";
	    public static String myEmailPassword = "younger646689";

	    public static String myEmailSMTPHost = "smtp.qq.com";

	    // 收件人邮箱（替换为自己知道的有效邮箱）
//	    public static String receiveMailAccount = "894168860@qq.com";
	    public static String receiveMailAccount = "yyyang@tju.edu.cn";
...
//	        MimeMessage message = createMimeMessage(session, myEmailAccount, receiveMailAccount);
	        ...
	        MimeMessage message = createMimeMessage1(session, myEmailAccount, receiveMailAccount);
...
//	        text_image.setContent(mm_text_image);
	        ...
	        DataHandler dh2 = new DataHandler(new FileDataSource("hustock.csv"));  // 读取本地文件
